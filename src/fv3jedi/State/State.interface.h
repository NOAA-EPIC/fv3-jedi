...
extern "C" {
  ...
  void fv3jedi_state_serializeSection_f90(const F90state &, const std::size_t &, double[], const int &, const int &, const int &, const int &);
  void fv3jedi_state_deserializeSection_f90(const F90state &, const std::size_t &, double[], const int &, const int &, const int &, const int &, int &, int &, int &, int &);
